...
A typical CMS has a lot of features, but sometimes they are hard to extend(especially in enterprise or system are complex). We belive that non-content features(eg. e-commerce) should be done by services, not in products(CMS), while the content related features should be in a framework way to have minimal&open architecture, then give freedom&quality to solution part.
